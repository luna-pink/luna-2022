...
client_auth = Client(api_key="9769892324696521437936494687419933645728555", aid="571492", application_secret="hdcyC1VvDapYpEOvDwtVBZPbGpKoXxu3a2I")
...
def auth():
    ...
    if username and password != "":
        ...
        if auth_choice == "1":
            ...
            login(username, password)
            input(f'PLEASE RESTART THE SELFBOT')
            time.sleep(9999)
        elif auth_choice == "2":
            email = result1
