...
def load_themes():
    with dpg.theme(tag="Dark"):
        with dpg.theme_component(dpg.mvAll):
            ...
            dpg.add_theme_color(dpg.mvThemeCol_Button, rose_pine.base, category=dpg.mvThemeCat_Core)
            ...
            dpg.add_theme_color(dpg.mvThemeCol_Header, rose_pine.muted, category=dpg.mvThemeCat_Core)
            dpg.add_theme_color(dpg.mvThemeCol_HeaderHovered, rose_pine.iris, category=dpg.mvThemeCat_Core)
