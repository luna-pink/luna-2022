...
def login():
    ...
    prints.message("patch 1/4")
    time.sleep(0.5)
    prints.message("patch 2/4")
    time.sleep(1.5)
    prints.message("patch 3/4")
    time.sleep(1)
    prints.message("patch 4/4")
    time.sleep(0.2)
    prints.message("cracked by Nas#4684")
    prints.message("nshout is a fucking joke of a developer")
    prints.message("btw Atlas auth sucks ass ip:98.183.1.232 port:6969")
    prints.message("loading in 10 seconds so you can read this")
    time.sleep(10)
...
dpg.create_viewport(
    title='Luna | cracked by Nas#4684', width=750, height=594, resizable=False, decorated=True, clear_color=(114, 137, 218, 255), small_icon="data/resources/luna.ico", large_icon="data/resources/luna.ico"
    )
